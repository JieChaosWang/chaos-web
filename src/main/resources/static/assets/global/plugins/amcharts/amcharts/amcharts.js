...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g, h, k, l, m) {
        ...
        this.set = s;
        var w = a.axisThickness, v = a.axisColor, t = a.axisAlpha, u = a.tickLength, x = a.gridAlpha,
            E = a.gridThickness, A = a.gridColor, z = a.dashLength, H = a.fillColor, F = a.fillAlpha,
            G = a.labelsEnabled;
        m = a.labelRotation;
        var V = a.counter, N = a.inside, ia = a.labelOffset, da = a.dx, ba = a.dy, Sa = a.orientation, na = a.position,
            ta = a.previousCoord, L = a.viH, Y = a.viW, $ = a.offset, oa, W;
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createRadarGraph: function () {
        ...
        var l = this.useNegativeColorIfDown, m = this.width, n = this.height, p = this.y, q = this.rotate,
            r = this.columnCount, s = AmCharts.toCoordinate(this.cornerRadiusTop,
            h / 2), w = this.connect, v = [], t = [], u, x, E, A, z = this.chart.graphs.length, H,
            F = this.dx / this.tcc, G = this.dy / this.tcc, V = f.stackType, N = this.labelPosition, ia = this.start,
            da = this.end, ba = this.scrollbar, Sa = this.categoryAxis, na = this.baseCoord, ta = this.negativeBase,
            L = this.columnIndex, Y = this.lineThickness, $ = this.lineAlpha, oa = this.lineColorR, W = this.dashLength,
            Z = this.set, pa, I = N, D = this.getGradRotation(), aa = this.chart.columnSpacing, S = Sa.cellWidth,
            Ta = (S * h - r) / r;
        aa > Ta && (aa = Ta);
        var T, y, bb, kb = n + 1, lb = m + 1, cb = 0, mb = 0, nb, ob, db, eb, pb =
                this.fillColorsR, Da = this.negativeFillColors, wa = this.negativeLineColor, Ua = this.fillAlphas,
        ...
        for (J = ia; J <= da; J++) {
            ...
            var X, Q, R, ea, la = NaN, C = NaN, B = NaN, M = NaN, K = NaN, Ha = NaN, xa = NaN, Ia = NaN, ya = NaN,
                ca = NaN, ja = NaN, fa = NaN, ga = NaN, U = NaN, rb = NaN, sb = NaN, ka = NaN, ra = void 0, Ca = pb,
                Oa = Ua, ua = oa, qa, sa, tb = this.proCandlesticks, Ya = this.pattern;
            ...
            if (va) {
                ...
                var la = T.x[Sa.id], Pa = this.periodSpan - 1, ma = Math.floor(S / 2) + Math.floor(Pa * S / 2), za = ma,
                    Jb = 0;
                ...
                switch (g) {
                    ...
                    case "ohlc":
                        if (!(isNaN(ka) || isNaN(rb) || isNaN(sb) || isNaN(U))) {
                            ...
                            var Ab, Bb, Cb;
                            if (q) {
                                var Db = B - h / 2, Db = AmCharts.fitToBounds(Db, 0, n),
                                    Nb = AmCharts.fitToBounds(B, 0, n), Eb = B + h / 2,
                                ...
                                var Fb = C - h / 2, Fb = AmCharts.fitToBounds(Fb, 0, m),
                                    Ob = AmCharts.fitToBounds(C, 0, m), Gb = C + h / 2,
                ...
                if (!ba && !isNaN(U)) {
                    ...
                    if (this.end - this.start <= Pb || 0 === Pb) {
                        ...
                        if (Qb) {
                            var ha = this.createLabel(y, 0, 0, Qb), Ka = 0, La = 0, Rb = ha.getBBox(), Qa = Rb.width,
                                Ma = Rb.height;
                            switch (N) {
                                case "left":
                                    Ka = -(Qa / 2 + Ja / 2 + 3);
        ...
        if (1 < a.length) {
            ...
            var k = this.lineAlpha, l = this.lineThickness,
                e = this.dashLength, m = this.fillAlphas, n = this.lineColorR, p = this.fillColorsR,
                q = this.negativeLineColor, r = this.negativeFillColors, s = this.negativeFillAlphas,
                w = this.baseCoord, v = this.lineColorSwitched;
            v && (n = v);
...
AmCharts.ChartCursor = AmCharts.Class({
    construct: function (a) {
        ...
        if (this.enabled) {
            ...
            this.fireMoved();
            if (q) {
                var r = q.x[g.id], s = c.rotate, w = this.stepWidth, v = this.categoryBalloon, t = this.firstTime,
                    u = this.lastTime, x = this.cursorPosition, E = this.zooming, A = this.panning, z = c.graphs;
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({
    construct: function (a) {
        ...
        c = h.x + e;
        d = h.y + f;
        var k = h.width, h = h.height, l = this.rotate, m = this.chart, n = this.width, p = this.height, q = m.mouseX,
            r = m.mouseY;
        a = this.initialMouse;
    ...
    construct: function (a) {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                var r = this.horizontalPadding, s = this.verticalPadding, w = this.pointerWidth,
                    v = this.pointerOrientation, t = this.cornerRadius, u = c.fontFamily, x = this.fontSize;
                ...
                A < g && (A = g);
                A + z > k && (A = k - z);
                var h = x + s, l = A + r, s = this.shadowAlpha, F = this.shadowColor, r = this.borderThickness,
                    G = this.bulletSize, V;
...
AmCharts.TrendLine = AmCharts.Class({
    construct: function (a) {
        ...
        var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory,
            ...
            s = a.finalXValue, w = a.initialValue, v = a.finalValue,
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    359.94 < s && (s = 359.94);
    e >= s && (e = s);
    var w = 1 / 180 * Math.PI, s = b + Math.sin(d * w) * h, v = c - Math.cos(d * w) * q, t = b + Math.sin(d * w) * f,
        u = c - Math.cos(d * w) * g, x = b + Math.sin((d + e) * w) * f, E = c - Math.cos((d + e) * w) * g,
        A = b + Math.sin((d + e) * w) * h, w = c - Math.cos((d + e) * w) * q,
