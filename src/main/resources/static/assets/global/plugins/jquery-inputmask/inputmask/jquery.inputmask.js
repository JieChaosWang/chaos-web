...
!function (factory) {
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function getTests(pos, ndxIntlzr, tstPs) {
            ...
            var maskTokens = getMaskSet().maskToken, testPos = ndxIntlzr ? tstPs : 0, ndxInitializer = ndxIntlzr || [0],
                    ...
                    $.valHooks[type] = {
                        get: function (elem) {
                            ...
                            if ($elem.data("_inputmask")) {
                                ...
                                var result = valueGet(elem), inputData = $elem.data("_inputmask"),
        ...
        function keyupEvent(e) {
            var $input = $(this), input = this, k = e.keyCode, buffer = getBuffer(), currentCaretPos = caret(input),
    ...
    if (void 0 === $.fn.inputmask) {
        var ua = ("function" == typeof ScriptEngineMajorVersion ? ScriptEngineMajorVersion() >= 10 : /*@cc_on (@_jscript_version >= 10) ||@*/ !1,
                navigator.userAgent), iphone = null !== ua.match(new RegExp("iphone", "i")),
